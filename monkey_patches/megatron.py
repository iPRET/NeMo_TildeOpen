...
#   Add allowed postiion_embedding_type "yarn", because megatron-lm already does support it and we need it.
#   The other changes are accidental and I hope they don't matter. But I'm leaving them in, because all sanity checks passed with the code as is currently.
...
class _DynamicMCoreLanguageModel(DynamicModule):
    ...
    def _setup(self):
        ...
        assert self.position_embedding_type in ["rope", "none", "yarn"], (
